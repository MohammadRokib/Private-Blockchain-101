...
<br>
This json file defines our genesis block which is the first block of our Blockchain. Here inside "alloc" I have given an address and put some balance. You can change the values inside "alloc" as you like. But don't change the other values. After doing that open terminal and run the following commands:
```
